  ...
  return (
    <section className="relative overflow-hidden bg-alf-crema">
      ...
      <Image
        ...
        height={1100}
        priority
        className="pointer-events-none absolute top-1/2 hidden max-w-none -translate-y-[40%] select-none lg:-right-28 lg:block lg:w-[340px] xl:-right-44 xl:w-[460px] 2xl:-right-45 2xl:w-[450px]"
      />

      <div className="relative mx-auto flex max-w-3xl flex-col items-center px-6 pt-32 pb-20 text-center lg:pt-56 lg:pb-32 xl:pt-40">
        <h1 className="font-heading text-4xl leading-tight text-alf-eerie-black md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-5xl">
