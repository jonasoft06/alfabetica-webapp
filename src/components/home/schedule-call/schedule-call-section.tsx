      ...
      <div className="mx-auto w-full max-w-7xl px-6">
        ...
        <div className="flex flex-col items-center gap-6 lg:flex-row lg:justify-center lg:gap-12">
          <Image
            ...
            width={120}
            height={120}
            className="h-auto w-24 max-w-none shrink-0 lg:w-48"
          />

          <p className="text-center font-sans text-lg leading-snug text-alf-eerie-black lg:text-end lg:text-2xl">
        ...
        <div className="relative mt-14 flex flex-col items-center gap-10 lg:mt-20 lg:min-h-120 lg:gap-0">
          <Image
            ...
            width={400}
            height={400}
            className="h-auto w-52 max-w-none lg:absolute lg:top-8 lg:left-0 lg:w-72 xl:w-98"
          />
          ...
          <Image
            ...
            width={480}
            height={480}
            className="h-auto w-64 max-w-none lg:absolute lg:top-32 lg:right-8 lg:w-80 xl:w-100"
          />
        </div>
      </div>
    </section>
